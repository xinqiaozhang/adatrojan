...
import logging
import pandas as pd
logging.basicConfig(filename='log0130.log', level=logging.WARNING, format='%(asctime)s - %(levelname)s - %(message)s')
...
class Detector(AbstractDetector):
    ...
    def infer(
        ...
        logits = self.inference_on_example_data(model, examples_dirpath)
